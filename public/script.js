...
// Append to form (liitä määrittelyt lomakkeelle) // 

form.append(firstNameLabel, firstNameInput,lastNameLabel,
lastNameInput,emailLabel, emailInput, phoneLabel, phoneInput,
submitButton)
...
// Append to root (vie #root - diviin)
...
populateTable = (list) => {
    ...
    headerRow.append(firstNameHeader, lastNameHeader, emailHeader,
